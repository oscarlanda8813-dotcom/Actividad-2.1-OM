...
namespace DirectorioONG.Models
{
    public class Administrador
    {
        ...
        // Versión A (Sin parámetros externos): Valida el acceso considerando únicamente si el estado está activo.
        public bool ValidarAcceso()
        {
            return EstadoActivo;
        }

        // Versión B (Con parámetro externo): Valida el acceso verificando el estado Y comparando una clave secreta recibida.
        public bool ValidarAcceso(string claveIngresada)
        {
            string claveMaster = "ONGAdmin2026"; // Clave requerida para el nivel de administrador
